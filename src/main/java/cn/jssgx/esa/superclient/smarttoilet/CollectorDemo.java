package cn.jssgx.esa.superclient.smarttoilet;
...
public class CollectorDemo {
    ...
    public static ModbusMaster getMaster() throws ModbusInitException {
        ...
        params.setPort(502);
//        DefaultSerialPortWrapperImpl wrapper = new DefaultSerialPortWrapperImpl("COM1", 9600,
//            SerialPort.DATABITS_8, SerialPort.STOPBITS_1, SerialPort.PARITY_NONE, 0, 0);

//        ModbusMaster master = modbusFactory.createRtuMaster(wrapper); //RTU 协议
...
//            System.out.println("v023:" + v023);
            ...
            // 03测试
            Number v031 = readHoldingRegister(1, 1, DataType.TWO_BYTE_INT_UNSIGNED);// 注意,float
            Number v032 = readHoldingRegister(1, 3, DataType.TWO_BYTE_INT_UNSIGNED);// 同上
